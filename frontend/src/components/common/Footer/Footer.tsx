        ...
        <div className="mx-auto max-w-7xl px-6 pb-10 pt-16">
            ...
            <div className="space-y-4">
              <div>
                <a href="/">
                  <div className="flex items-center space-x-2 text-2xl font-medium">
                    ...
                    <span className="text-foreground">AIOps</span>
                  </div>
                </a>
              </div>
              <div className="max-w-md pr-16 text-md text-foreground-200">
              ...
              <div className="flex space-x-2">
                <a
                  href=""
                  target="_blank"
                  className="text-foreground-200 hover:text-foreground-200"
                >
                ...
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a
                        href="/aiplatform"
                        className="text-md leading-6 text-foreground-300 hover:text-foreground-50"
                      >
                        AI Platform
                      </a>
                    </li>
          ...
          <div className="mt-16 border-t border-gray-400/30 pt-8 sm:mt-20 lg:mt-24">
            <div className="text-md text-center text-foreground">
              ...
              <span className="text-foreground-50">♥</span> by AI enthusiasts at
              <a rel="noopener" href="/">
                AIOps.
              </a>
            </div>
